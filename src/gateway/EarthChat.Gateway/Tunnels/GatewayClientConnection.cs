...
public sealed partial class GatewayClientConnection : IAsyncDisposable
{
        ...
        ConnectionConfig config, ILogger logger)
    {
        ...
        if (config.KeepAlive && keepAliveInterval > TimeSpan.Zero)
        {
            ...
            this._keepAliveTimer =
                new Timer(this.KeepAliveTimerTick, null, (TimeSpan)keepAliveInterval, keepAliveInterval);
        }
        else
        {
