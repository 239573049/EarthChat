    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatGroupInUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChatGroupInUsers_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatGroupInUsers_ChatGroups_ChatGroupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbpUsers_GiteeId",
                table: "AbpUsers",
                column: "GiteeId");

            migrationBuilder.CreateIndex(
                name: "IX_AbpUsers_GitHubId",
                table: "AbpUsers",
                column: "GitHubId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatGroupInUsers_UserId",
                table: "ChatGroupInUsers",
                column: "UserId");
