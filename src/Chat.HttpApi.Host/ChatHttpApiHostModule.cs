...
public class ChatHttpApiHostModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        ConfigureFreeRedis(context, configuration);
    ...
    private void ConfigureOptions(ServiceConfigurationContext context, IConfiguration configuration)
    {
        ...
        context.Services.Configure<MinIOOptions>(minIO);

        var fileOptions = configuration.GetSection("FileOptions");

        context.Services.Configure<FileOptions>(fileOptions);
    }
    ...
    private void ConfigureFreeRedis(ServiceConfigurationContext context, IConfiguration configuration)
    {
        context.Services.AddSingleton(servers => new RedisClient(configuration["Redis:Configuration"]));
    }
