...
const Gitee = () => {
    return <svg onClick={()=>{
        location.href = `https://gitee.com/oauth/authorize?client_id=${import.meta.env.VITE_GITEE_ID}&redirect_uri=${location.origin}/oauth/gitee&response_type=code`;
    }} style={{
        cursor: 'pointer',
        margin: '0 20px 0 5px',
...
const GetHub = () => {
    return <svg onClick={()=>{
        location.href = `https://github.com/login/oauth/authorize?client_id=${import.meta.env.VITE_GITHUB_ID}&redirect_uri=${location.origin}/oauth/github&response_type=code`;
    }}  style={{
        cursor: 'pointer',
        margin: '0 20px 0 5px',
